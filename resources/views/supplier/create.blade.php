                    ...
                    <div class="tile-body">
                        <form method="POST" action="{{route('supplier.store')}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" type="text" placeholder="Enter Name of Supplier">
                                @error('name')
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="mobile" value="{{ old('mobile') }}" class="form-control @error('mobile') is-invalid @enderror" type="text" placeholder="Enter Contact Number of Supplier">
                                @error('mobile')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            {{-- <div class="form-group col-md-12">
                                ...
                                <input name="previous_balance" value="{{ old('previous_balance') }}" class="form-control @error('previous_balance') is-invalid @enderror" type="text" placeholder="Enter Unit Name">
