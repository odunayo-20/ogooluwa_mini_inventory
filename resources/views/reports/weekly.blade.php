...
@section('content')
    ...
    <main class="app-content">
        ...
        <div class="d-flex justify-content-between">
            ...
            <a class="btn btn-danger" href="{{ route('report.downloadWeekly', 'pdf') }}">Download PDF</a>

        </div>


        <h2>Weekly Sales Report - {{ now()->startOfWeek()->format('Y-m-d') }} to {{ now()->endOfWeek()->format('Y-m-d') }}
        </h2>
        <div class="row mt-2">
            <div class="col-md-12">
                <div class="tile">
